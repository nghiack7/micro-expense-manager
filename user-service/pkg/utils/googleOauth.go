...
func GetGoogleOauthToken(code string) (*GoogleOauthToken, error) {
	...
	values.Add("client_id", config.ConfigApp.GoogleClientID)
	values.Add("client_secret", config.ConfigApp.GoogleClientSecret)
	values.Add("redirect_uri", config.ConfigApp.GoogleOAuthRedirectUrl)
